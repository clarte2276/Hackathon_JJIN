...
// notice 게시판 검색 기능 (제목, 내용, 작성자 검색 가능)
...
// 게시판 목록 가져오기 라우트 설정 notice
router.get('/notice', (req, res) => {
  getNoticeBoardList(res);
});

// suggest 게시판 검색 기능 (제목, 내용, 작성자 검색 가능)
